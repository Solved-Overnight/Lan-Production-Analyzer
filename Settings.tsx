  ...
  const exportProfessionalReport = async () => {
    ...
    try {
      ...
      for (let i = 0; i < sections.length; i++) {
        ...
        else if (isLandscape) pdf.internal.pageSize.setProperties({ width: 297, height: 210 });
          ...
          <>
            ...
            <div className="pdf-section p-10 space-y-8 bg-white min-h-[297mm]">
               ...
               <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200 shadow-inner">
                  <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] mb-8 flex items-center gap-2"><BarChart size={18} className="text-indigo-500" /> UNIT COMPARISON HISTORY</h3>
                  <div className="h-72">
