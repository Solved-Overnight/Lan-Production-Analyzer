  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-500">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-2">
        ...
        <div className="flex bg-app-card p-1 rounded-md border border-app-border shadow-sm">
...
const KPICard: React.FC<{ 
  ...
  return (
    <div className="bg-app-card p-5 rounded-lg shadow-sm border border-app-border transition-all hover:border-app-accent duration-300">
