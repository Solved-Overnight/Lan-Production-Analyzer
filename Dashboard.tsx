...
import { 
  ...
  Droplets, Leaf, Gauge, PieChart as PieChartIcon, AlertCircle, Percent
} from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-4 bg-app-card p-6 rounded-lg shadow-sm border border-app-border">
        ...
        <div className="lg:col-span-8 bg-app-card p-6 rounded-lg shadow-sm border border-app-border">
      ...
      <div className="bg-app-card p-6 rounded-lg shadow-sm border border-app-border">
        ...
        <ProductionTrendChart data={records.slice(-20).map(r => ({ date: r.date, lantabur: r.lantabur.total, taqwa: r.taqwa.total }))} />
      </div>
