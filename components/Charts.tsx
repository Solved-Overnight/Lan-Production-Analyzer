      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis 
            ...
            interval={0}
            dy={5}
            // Fix: Removed 'angle' as it's not a valid property of SVGProps<SVGTextElement>
          ...
          <Legend 
            ...
            wrapperStyle={{ 
              ...
              top: 5 // Moved it down further as requested
            }}
          />
          <Bar 
            name="Lantabur" 
    ...
    <div className="h-64 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
          ...
          <YAxis stroke={text} fontSize={9} tickLine={false} axisLine={false} tickFormatter={(val) => val >= 1000 ? `${(val/1000).toFixed(1)}k` : val} />
          <Tooltip contentStyle={{ backgroundColor: card, borderRadius: '4px', border: `1px solid ${grid}`, fontSize: '11px' }} />
          <Legend wrapperStyle={{ fontSize: '10px', fontWeight: 'bold', paddingTop: '15px' }} iconType="rect" verticalAlign="bottom" />
